...
def enterSentences(sql, cursor, sentences, filename, textid, annotatorName, eraseAllAnnos, notenter=["order"], sentencefeatures={}, defaultAnnotatorName="prof", tokname=None):
	"""
				...
				for sentenceid,nr,sentence,textid in r[mini:]: 
					...
					if sentence==inssentence:
						...
						if len(origdic)==len(tree):
							...
							print defaultAnnotatorName,origdic
							print tree
...
if __name__ == "__main__":
	...
	#readinallmates("NaijaSUDtemp", "/home/gerdes/arborator/projects/NaijaSUDtemp/parsed/", filepattern="*", preserveSampleWithSameName=False)
	...
	#readinallmates("Hieu","../corpus/conll/",filepattern="Hieu009.conll10",steps=10000,importAnnotatorName="parser")
	#readinallmates("Bambara","../corpus/conll/bambarapropre/",filepattern="sud*conllu",steps=10000,importAnnotatorName="katya")
	#readinallmates("Bambara","../corpus/conll/bambarapropre/",filepattern="konta*conllu",steps=10000,importAnnotatorName="mate")
	#print "ok"
	#enterConll("SUDfr", "../corpus/conll/prepaScientifique.conllu","ud2sud")
	#enterConll("SUDfr", "../corpus/conll/degradedSud/prepaScientifique","ud2sud")
	
        trees = conll.conllFile2trees("../projects/NaijaSUD/export/D_PRT_03_D_Football_TRANS.eaf.csv.maigida.trees.conll10")
        simpleEnterSentences(database.SQL("NaijaSUD"), trees, "D_PRT_03_D_Football_TRANS.eaf.csv", "maigida", False)
	print "ok"
