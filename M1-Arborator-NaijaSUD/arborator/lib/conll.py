...
class Tree(dict):
	...
	def dictrepr(self): # TODO: temp workaround for solving encoding issues when printing trees
...
def trees2conllFile(trees, outfile, columns="u", includeSentenceFeatures=True): # changed default from 10 to u!
	"""
...
if __name__ == "__main__":
	...
	sentences2emptyConllFile("InterviewWeb01-u_seg.corr.txt","InterviewWeb01-u_seg.corr.conll")
	#print len(ts)
	#print ts[0]
