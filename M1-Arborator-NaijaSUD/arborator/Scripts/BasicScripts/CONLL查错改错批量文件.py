...
for files in file_list:
    ...
    print(text_name)
    w=open("E:/TAL/Stage/arborator/projects/NaijaSUD/export/Correction/correction_newest/"+text_name+".conll","w")
                ...
                if list_line[1] in token:
                    if [list_line[1],list_line[3]] in token_categorie:
                        ...
                        if "|" in r:
                            ...
                            l=sorted(m)
                            o="|".join(l)
                        if [list_line[1],list_line[3],list_line[5]] in lexique or [list_line[1],list_line[3],o] in lexique :
                            w.write(line)
                        else:
